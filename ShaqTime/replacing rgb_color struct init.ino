...
//int keyState = HIGH;         // variable for reading the pushbutton status
//int buttonState = HIGH;         // variable for reading the pushbutton status
//int buttonToggle = LOW;
//
...
//
//		// If ST not going on, check state of button
//		if (keyState == LOW && buttonToggle == LOW) {
...
//
//
//		// Activate Shaq Ready (TM)
//		if (keyState == LOW) {
//				// Activate Shaq Time (R)
...
//						float mod = 20 * sin(millis() / 10);
//						readyColor.red = 25 + (int)mod;
//						readyColor.green = 0;
//						readyColor.blue = 0;
//
//						for (int i = 0; i < LED_COUNT; i++) {
//								//readyColor.red = readyColor.red + 20 * sin(2 * PI * i / LED_COUNT);
//
//								colors[i] = readyColor;
//						}
//
...
//		}
//		else {
//				// Do nothing/deactivate Shaq Ready
//				//digitalWrite(ledPin, LOW);
//				buttonToggle = LOW;
//
//				rgb_color offColor;
...
//				if (i + 1 < LED_COUNT)
//				{
//						rgb_color oddLEDColor;
//						oddLEDColor.red = colors[i].red >> 2;
//						oddLEDColor.green = colors[i].green >> 2;
//						oddLEDColor.blue = colors[i].blue >> 2;
//						//colors[i+1] = (rgb_color){colors[i].red >> 2, colors[i].green >> 2, colors[i].blue >> 2};
//						colors[i + 1] = oddLEDColor;
//				}
//		}
//}
//
...
//						if (i % 2)
//						{
//								rgb_color redColor = { maxBrightness, 0, 0 };
...
//						rgb_color initColor;
//						initColor.red = random(maxBrightness);
//						initColor.green = random(maxBrightness);
//						initColor.blue = random(maxBrightness);
